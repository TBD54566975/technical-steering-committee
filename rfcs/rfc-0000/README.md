...
The RFC process is required when proposing substantial changes to the specifications, software
...
* **Enhanced decision-making**: The RFC process provides a clear framework for evaluating proposals
